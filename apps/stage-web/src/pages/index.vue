...
// --- Vision system ---
// NOTICE: pendingWelcome and pendingMessage watchers are handled in App.vue (always mounted).
// They were previously duplicated here, causing double-fire when both App.vue and index.vue
